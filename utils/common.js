                            ...
                            if (code) {
                                wx.getUserInfo({
                                    success: (res) => {
                                        ...
                                        wx.request({
                                            url: 'https://collhome.com/shandong-nongyegongcheng/apis/register',
                                            method: 'POST',
                                            data: {
                                                code: code,
                                            ...
                                            success: function (res) {
                                                ...
                                                wx.request({
                                                    url: 'https://collhome.com/shandong-nongyegongcheng/apis/user?wesecret=' + wesecret,
                                                    success: function (res) {
                    ...
                    wx.showActionSheet({
                        ...
                        success: function (res) {
                            if (res.tapIndex == 0) {
                                ...
                                wx.request({
                                    url: 'https://collhome.com/shandong-nongyegongcheng/apis/delete/love',
                                    method: 'POST',
                                    data: {
                                        wesecret: wesecret,
                                        love_id: love_id
                    ...
                    wx.showActionSheet({
                        ...
                        success: function (res) {
                            if (res.tapIndex == 0) {
                                let wesecret = wx.getStorageSync('wesecret');
                                wx.request({
                                    url: 'https://collhome.com/shandong-nongyegongcheng/apis/delete/comment',
                                    method: 'POST',
                                    data: {
                                        wesecret: wesecret,
                    ...
                    wx.showActionSheet({
                        ...
                        success: function (res) {
                            if (res.tapIndex == 0) {
                                let wesecret = wx.getStorageSync('wesecret');
                                wx.request({
                                    url: 'https://collhome.com/shandong-nongyegongcheng/apis/delete/reply',
                                    method: 'POST',
                                    data: {
                                        wesecret: wesecret,
                                        reply_id: reply_id
...
function praiseLove(e) {
    ...
    return new Promise((resolve, reject) => {
        ...
        let wesecret = wx.getStorageSync('wesecret');
        wx.request({
            url: 'https://collhome.com/shandong-nongyegongcheng/apis/loves/' + love_id + '/praises',
            method: 'POST',
            data: {
                wesecret: wesecret,
                praise: praise
...
function praiseComment(e) {
    ...
    return new Promise((resolve, reject) => {
        ...
        let wesecret = wx.getStorageSync('wesecret');
        wx.request({
            url: `https://collhome.com/shandong-nongyegongcheng/apis/comments/${comment_id}/praises`,
            method: 'POST',
            data: {
                wesecret: wesecret,
                praise: praise
...
function praiseUser(e) {
    ...
    return new Promise((resolve, reject) => {
        ...
        let wesecret = wx.getStorageSync('wesecret');
        wx.request({
            url: `https://collhome.com/shandong-nongyegongcheng/apis/users/${user_id}/praises`,
            method: 'POST',
            data: {
                wesecret: wesecret,
                praise: praise
