                            ...
                            if (code) {
                                wx.getUserInfo({
                                    success: (res) => {
                                        ...
                                        wx.request({
                                            url: 'https://collhome.com/beijing/apis/register',
                                            method: 'POST',
                                            data: {
                                                code: code,
                    ...
                    wx.showActionSheet({
                        ...
                        success: function (res) {
                            if (res.tapIndex == 0) {
                                ...
                                wx.request({
                                    url: 'https://collhome.com/beijing/apis/delete/love',
                                    method: 'POST',
                                    data: {
                                        wesecret: wesecret,
                                        love_id: love_id
                    ...
                    wx.showActionSheet({
                        ...
                        success: function (res) {
                            if (res.tapIndex == 0) {
                                let wesecret = wx.getStorageSync('wesecret');
                                wx.request({
                                    url: 'https://collhome.com/beijing/apis/delete/comment',
                                    method: 'POST',
                                    data: {
                                        wesecret: wesecret,
                    ...
                    wx.showActionSheet({
                        ...
                        success: function (res) {
                            if (res.tapIndex == 0) {
                                let wesecret = wx.getStorageSync('wesecret');
                                wx.request({
                                    url: 'https://collhome.com/beijing/apis/delete/reply',
                                    method: 'POST',
                                    data: {
                                        wesecret: wesecret,
                                        reply_id: reply_id
...
function praiseLove(e) {
    ...
    return new Promise((resolve, reject) => {
        ...
        let wesecret = wx.getStorageSync('wesecret');
        wx.request({
            url: 'https://collhome.com/beijing/apis/loves/' + love_id + '/praises',
            method: 'POST',
            data: {
                wesecret: wesecret,
                praise: praise
...
function praiseComment(e) {
    ...
    return new Promise((resolve, reject) => {
        ...
        let wesecret = wx.getStorageSync('wesecret');
        wx.request({
            url: `https://collhome.com/beijing/apis/comments/${comment_id}/praises`,
            method: 'POST',
            data: {
                wesecret: wesecret,
                praise: praise
...
function praiseUser(e) {
    ...
    return new Promise((resolve, reject) => {
        ...
        let wesecret = wx.getStorageSync('wesecret');
        wx.request({
            url: `https://collhome.com/beijing/apis/users/${user_id}/praises`,
            method: 'POST',
            data: {
                wesecret: wesecret,
                praise: praise
