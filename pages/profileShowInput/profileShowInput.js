...
Page({
    ...
    onLoad: function () {
        ...
        wx.request({
            url: 'https://collhome.com/fujian-huaqiao/apis/colleges',
        ...
        wx.request({
            url: 'https://collhome.com/fujian-huaqiao/apis/grades',
            success: function (res) {
    ...
    deleteUserPicture: function (picture) {
        let that = this;
        wx.request({
            url: 'https://collhome.com/fujian-huaqiao/apis/delete/user/picture',
            method: 'POST',
            data: {
    ...
    saveUserPicture: function (upload_files, successUp, failUp, i, length) {
        let that = this;
        wx.uploadFile({
            url: 'https://collhome.com/fujian-huaqiao/apis/users/pictures',
