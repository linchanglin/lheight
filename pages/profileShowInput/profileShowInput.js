...
Page({
    ...
    onLoad: function () {
        ...
        wx.request({
            url: 'https://collhome.com/jiangxi-jingdezhen/apis/colleges',
        ...
        wx.request({
            url: 'https://collhome.com/jiangxi-jingdezhen/apis/grades',
            success: function (res) {
    ...
    saveUserPicture: function (upload_files, successUp, failUp, i, length) {
        let that = this;
        wx.uploadFile({
            url: 'https://collhome.com/jiangxi-jingdezhen/apis/users/pictures',
