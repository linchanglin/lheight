...
Page({
    ...
    onLoad: function () {
        ...
        wx.request({
            url: 'https://collhome.com/guangdong-zhongkainongye/apis/colleges',
        ...
        wx.request({
            url: 'https://collhome.com/guangdong-zhongkainongye/apis/grades',
            success: function (res) {
    ...
    deleteUserPicture: function (picture) {
        let that = this;
        wx.request({
            url: 'https://collhome.com/guangdong-zhongkainongye/apis/delete/user/picture',
            method: 'POST',
            data: {
    ...
    formSubmit: function (e) {
        ...
        wx.request({
            url: 'https://collhome.com/guangdong-zhongkainongye/apis/users',
            data: {
                'wesecret': that.data.wesecret,
                'userInfo': submitData,
            },
    ...
    saveUserPicture: function (upload_files, successUp, failUp, i, length) {
        let that = this;
        wx.uploadFile({
            url: 'https://collhome.com/guangdong-zhongkainongye/apis/users/pictures',
