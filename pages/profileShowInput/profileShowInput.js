...
Page({
    ...
    onLoad: function () {
        ...
        wx.request({
            url: 'https://collhome.com/shandong-nongyegongcheng/apis/grades',
            success: function (res) {
    ...
    deleteUserPicture: function (picture) {
        let that = this;
        wx.request({
            url: 'https://collhome.com/shandong-nongyegongcheng/apis/delete/user/picture',
            method: 'POST',
            data: {
    ...
    saveUserPicture: function (upload_files, successUp, failUp, i, length) {
        let that = this;
        wx.uploadFile({
            url: 'https://collhome.com/shandong-nongyegongcheng/apis/users/pictures',
