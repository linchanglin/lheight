...
Page({
    ...
    onLoad: function () {
        ...
        wx.request({
            url: 'https://collhome.com/tianjin-jidianzhiye/apis/colleges',
        ...
        wx.request({
            url: 'https://collhome.com/tianjin-jidianzhiye/apis/grades',
            success: function (res) {
    ...
    deleteUserPicture: function (picture) {
        let that = this;
        wx.request({
            url: 'https://collhome.com/tianjin-jidianzhiye/apis/delete/user/picture',
            method: 'POST',
            data: {
    ...
    formSubmit: function (e) {
        ...
        wx.request({
            url: 'https://collhome.com/tianjin-jidianzhiye/apis/users',
            data: {
                'wesecret': that.data.wesecret,
                'userInfo': submitData,
            },
    ...
    saveUserPicture: function (upload_files, successUp, failUp, i, length) {
        let that = this;
        wx.uploadFile({
            url: 'https://collhome.com/tianjin-jidianzhiye/apis/users/pictures',
