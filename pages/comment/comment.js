...
Page({
    ...
    load_refresh_comments: function (need_refresh_comment_id) {
        ...
        let url;
        if (wesecret) {
            url = `https://collhome.com/beijing/apis/comments/${need_refresh_comment_id}?wesecret=${wesecret}`
        } else {
            url = `https://collhome.com/beijing/apis/comments/${need_refresh_comment_id}`
        }
        wx.request({
            url: url,
    ...
    load_love: function () {
        ...
        let love_url;
        if (wesecret) {
            love_url = `https://collhome.com/beijing/apis/loves/${love_id}?wesecret=${wesecret}`;
        } else {
            love_url = `https://collhome.com/beijing/apis/loves/${love_id}?wesecret=`;
        }
        wx.request({
            url: love_url,
            success: function (res) {
    ...
    load_comments: function (parameter) {
        ...
        let comments_url;
        if (wesecret) {
            comments_url = `https://collhome.com/beijing/apis/loves/${love_id}/comments?page=${page}&wesecret=${wesecret}`
        } else {
            comments_url = `https://collhome.com/beijing/apis/loves/${love_id}/comments?page=${page}&wesecret=`;
        }
        wx.request({
            url: comments_url,
            success: function (res) {
