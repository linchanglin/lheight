...
Page({
    ...
    get_unreadLoveNums: function () {
        ...
        let wesecret = wx.getStorageSync('wesecret');
        if (wesecret) {
            url = `https://collhome.com/guangdong-zhongkainongye/apis/unreadLoveNums?love_id=${love_id}&wesecret=${wesecret}`
        } else {
            url = `https://collhome.com/guangdong-zhongkainongye/apis/unreadLoveNums?love_id=${love_id}&wesecret=`
        }
        wx.request({
            url: url,
            success: function (res) {
    ...
    load_loves: function (parameter) {
        ...
        let url;
        if (wesecret) {
            url = `https://collhome.com/guangdong-zhongkainongye/apis/loves?type=${type}&page=${page}&search=${search}&wesecret=${wesecret}`
        } else {
            url = `https://collhome.com/guangdong-zhongkainongye/apis/loves?type=${type}&page=${page}&search=${search}&wesecret=`
        }
        wx.request({
            url: url,
            success: function (res) {
