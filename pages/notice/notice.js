Page({
    ...
    load_notices: function (parameter) {
        ...
        wx.request({
            url: `https://collhome.com/shandong-nongyegongcheng/apis/notices?wesecret=${wesecret}&page=${page}`,
    ...
    navigateToSource: function (e) {
        ...
        if (notice_ifRead == 0) {
            wx.request({
                url: 'https://collhome.com/shandong-nongyegongcheng/apis/read/notice',
                method: 'POST',
                data: {
