...
Page({
    ...
    load_systemNotices: function (parameter) {
        ...
        wx.request({
            url: `https://collhome.com/tianjin-jidianzhiye/apis/systemNotices?wesecret=${wesecret}&page=${page}`,
            success: function (res) {
                ...
                if (parameter && parameter == 'onLoad') {
                    if (systemNotices.length > 0) {
                        ...
                        wx.request({
                            url: 'https://collhome.com/tianjin-jidianzhiye/apis/read/systemNotice',
                            method: 'post',
                            data: {
                                wesecret: wesecret,
