...
Page({
    ...
    load_systemNotices: function (parameter) {
        ...
        wx.request({
            url: `https://collhome.com/jiangxi-jingdezhen/apis/systemNotices?wesecret=${wesecret}&page=${page}`,
            success: function (res) {
                ...
                if (parameter && parameter == 'onLoad') {
                    if (systemNotices.length > 0) {
                        ...
                        wx.request({
                            url: 'https://collhome.com/jiangxi-jingdezhen/apis/read/systemNotice',
                            method: 'post',
                            data: {
                                wesecret: wesecret,
