...
Page({
    ...
    load_pictures: function (parameter) {
        ...
        let url;
        if (wesecret) {
            url = `https://collhome.com/jiangxi-jingdezhen/apis/pictures?page=${page}&search=${search}&wesecret=${wesecret}`
        } else {
            url = `https://collhome.com/jiangxi-jingdezhen/apis/pictures?page=${page}&search=${search}&wesecret=`
        }
        wx.request({
            url: url,
