Page({
    ...
    load_badReportTypes: function () {
        let that = this;
        wx.request({
            url: 'https://collhome.com/guangdong-zhongkainongye/apis/badReportTypes',
    ...
    submitBadReport: function () {
        ...
        if (badReportFrom_id == 1) {
            url = `https://collhome.com/guangdong-zhongkainongye/apis/badReports/love/${badReport_id}`
        } else if (badReportFrom_id == 2) {
            url = `https://collhome.com/guangdong-zhongkainongye/apis/badReports/comment/${badReport_id}`
        } else if (badReportFrom_id == 3) {
            url = `https://collhome.com/guangdong-zhongkainongye/apis/badReports/reply/${badReport_id}`
        } else {
            url = `https://collhome.com/guangdong-zhongkainongye/apis/badReports/user/${objectUser_id}`
        }
        let badReport_type;
        if (that.data.index) {
