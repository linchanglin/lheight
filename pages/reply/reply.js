...
Page({
    ...
    load_comment: function () {
        ...
        let comment_url;
        if (wesecret) {
            comment_url = `https://collhome.com/shanghai/apis/comments/${comment_id}?wesecret=${wesecret}`;
        } else {
            comment_url = `https://collhome.com/shanghai/apis/comments/${comment_id}?wesecret=`;
        }
        wx.request({
            url: comment_url,
    ...
    load_replies: function (parameter) {
        ...
        let replies_url;
        if (wesecret) {
            replies_url = `https://collhome.com/shanghai/apis/comments/${comment_id}/replies?page=${page}&wesecret=${wesecret}`;
        } else {
            replies_url = `https://collhome.com/shanghai/apis/comments/${comment_id}/replies?page=${page}&wesecret=`;
        }
        wx.request({
            url: replies_url,
            success: function (res) {
    ...
    praiseReply: function (e) {
        ...
        if (wesecret) {
            ...
            wx.request({
                url: `https://collhome.com/shanghai/apis/replies/${reply_id}/praises`,
                method: 'POST',
                data: {
                    wesecret: wesecret,
                    praise: praise
