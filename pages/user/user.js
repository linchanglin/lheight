...
Page({
    ...
    get_unreadNoticeNums: function () {
        ...
        if (wesecret) {
            wx.request({
                url: `https://collhome.com/tianjin-jidianzhiye/apis/unreadNoticeNums?wesecret=${wesecret}`,
    ...
    get_unreadSystemNoticeNums: function () {
        ...
        if (wesecret) {
            wx.request({
                url: `https://collhome.com/tianjin-jidianzhiye/apis/unreadSystemNoticeNums?wesecret=${wesecret}`,
                success: function (res) {
