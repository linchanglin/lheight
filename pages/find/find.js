...
Page({
    ...
    load_imageLoves: function (parameter) {
        ...
        let url;
        if (wesecret) {
            url = `https://collhome.com/shandong-nongyegongcheng/apis/loves?type=${type}&page=${image_page}&search=${search}&wesecret=${wesecret}`
        } else {
            url = `https://collhome.com/shandong-nongyegongcheng/apis/loves?type=${type}&page=${image_page}&search=${search}&wesecret=`
        }
        wx.request({
            url: url,
            success: function (res) {
    ...
    load_videoLoves: function (parameter) {
        ...
        let url;
        if (wesecret) {
            url = `https://collhome.com/shandong-nongyegongcheng/apis/loves?type=${type}&page=${video_page}&search=${search}&wesecret=${wesecret}`
        } else {
            url = `https://collhome.com/shandong-nongyegongcheng/apis/loves?type=${type}&page=${video_page}&search=${search}&wesecret=`
        }
        wx.request({
            url: url,
            success: function (res) {
