...
Page({
    ...
    load_refresh_loves: function (need_refresh_love_id) {
        ...
        let url;
        if (wesecret) {
            url = `https://collhome.com/guangdong-zhongkainongye/apis/loves/${need_refresh_love_id}?wesecret=${wesecret}`
        } else {
            url = `https://collhome.com/guangdong-zhongkainongye/apis/loves/${need_refresh_love_id}?wesecret=`
        }
        wx.request({
            url: url,
            success: function (res) {
    ...
    load_hotLoves: function (parameter) {
        ...
        let url;
        if (wesecret) {
            url = `https://collhome.com/guangdong-zhongkainongye/apis/loves?type=${type}&page=${hot_page}&search=${search}&wesecret=${wesecret}`
        } else {
            url = `https://collhome.com/guangdong-zhongkainongye/apis/loves?type=${type}&page=${hot_page}&search=${search}&wesecret=`
        }
        wx.request({
            url: url,
            success: function (res) {
    ...
    load_imageLoves: function (parameter) {
        ...
        let url;
        if (wesecret) {
            url = `https://collhome.com/guangdong-zhongkainongye/apis/loves?type=${type}&page=${image_page}&search=${search}&wesecret=${wesecret}`
        } else {
            url = `https://collhome.com/guangdong-zhongkainongye/apis/loves?type=${type}&page=${image_page}&search=${search}&wesecret=`
        }
        wx.request({
            url: url,
            success: function (res) {
    ...
    load_videoLoves: function (parameter) {
        ...
        let url;
        if (wesecret) {
            url = `https://collhome.com/guangdong-zhongkainongye/apis/loves?type=${type}&page=${video_page}&search=${search}&wesecret=${wesecret}`
        } else {
            url = `https://collhome.com/guangdong-zhongkainongye/apis/loves?type=${type}&page=${video_page}&search=${search}&wesecret=`
        }
        wx.request({
            url: url,
            success: function (res) {
