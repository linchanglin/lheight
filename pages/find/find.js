...
Page({
    data: {
        // 测试用
        test_loves: [
            {id: 1, content: '我喜欢余生这个词多么好听，想表达什么呢，岁月如风，刮来阵阵暖意，又刮走了人们的念想，岁月如酒，香椿而又清香，醉时的的你又那么深意。它时刻都在，他在和你挥手，但你又抓不住它，是啊，如此反复出现在你的面'},
            {id: 2, content: '云一样的思绪，飘过来又飘过去，最终还是落在我的手掌上。绚丽如霓霞，哀怨如晨雾。我看得清你，你看得清我，我们在同一地平线，做着不同的梦，我的梦白如花朵，你的梦红如晚霞。'},
