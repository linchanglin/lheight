...
Page({
    ...
    load_user: function () {
        ...
        let url;
        if (wesecret) {
            url = `https://collhome.com/shandong-nongyegongcheng/apis/users/${user_id}?wesecret=${wesecret}`
        } else {
            url = `https://collhome.com/shandong-nongyegongcheng/apis/users/${user_id}?wesecret=`
        }
        wx.request({
            url: url,
